...
\section{Iteration 2}
In der zweiten Iteration wollten die Hauptfrage auch Iteration 1 klären. Was ausser guten Reports brauchten die Nutzer noch? Die individuelle Recherche zuhause hat nicht die gewünschten Ergebnisse geliefert. Daher fuhren wir fort einfach den Prozess zu durchlaufen und Ideen zu suchen, indem wir uns mit dem Thema beschäftigten. Wir machten nochmals Storyboards und kurz darauf erste Prototypen. Wir sahen das erste Mal was sich welches Teammitglied als Lösung vorstellte.
...
Informationen zu den rechtlichen Anforderungen erhielten wir im Interview vom 23. März erhalten. Aktuell ist dies keine Benutzeranforderung sondern ein Domain-Requirement.
...
\section{Validate}
Validierung über ein vorgefertigtes Protokoll.
