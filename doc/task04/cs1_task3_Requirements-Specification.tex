...
\paragraph{Darstellung Dashboard}
Das System soll beim starten sowie auf klick auf einen Menu-Punkt ein Dashboard anzeigen. Dieses Dashboard soll in Kacheln die wichtigsten 
\paragraph{Dashboard Konfiguration}
\paragraph{Schnittstelle DBS}
